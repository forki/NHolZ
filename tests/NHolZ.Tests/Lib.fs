...
// Commentato perché su Mono fallisce semplicemente a causa di una diversa gestione del 
// ritorno di riga /n al posto di /r/n e non è un test così importante
//(* do_map tests *)
//
...
// Commentato per lo stesso motivo di sopra su Mono fallisce per 
// una diversa gestione del ritorno di riga \n al posto di \r\n
// e non è un test così importante.
//(* report tests *)
//
//[<Test>]
//let ``report_test``() =

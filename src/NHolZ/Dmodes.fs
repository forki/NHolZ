...
let set_type_annotation_mode l =
    report ("Setting type annotation mode to " + string_of_level l) |> ignore
...
let set_tyvar_marking_mode l =
    report ("Setting type variable annotation mode to " + string_of_level l) |> ignore
...
let set_var_marking_mode l =
    report ("Setting variable annotation mode to " + string_of_level l) |> ignore
...
let set_language_level_mode l =
    report ("Setting language level mode to " + string_of_level l) |> ignore
...
let show_display_modes () =
  (printfn "%s" "HOL Zero Display Modes";
   printfn "%s" ("   Type annotation mode :        " + string_of_level (get_type_annotation_mode ()));
   printfn "%s" ("   Variable marking mode :       " + string_of_level (get_var_marking_mode ()));
   printfn "%s" ("   Type variable marking mode :  " + string_of_level (get_tyvar_marking_mode ()));
   printfn "%s" ("   Language level mode :         " + string_of_level (get_tyvar_marking_mode ())))